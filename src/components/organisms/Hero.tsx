      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-navy-900 leading-tight">
            Discover AI That{' '}
            <span className="text-primary-500">Transforms</span>
            <br />
            Your Workflow
          </h1>
          ...
          >
            <button className="bg-primary-500 hover:bg-primary-600 text-white px-8 py-4 rounded-lg font-semibold transition-colors shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
              Explore AI Solutions
            </button>
            <button className="text-gray-600 hover:text-navy-900 px-8 py-4 font-medium transition-colors">
              Watch Demo
            </button>
          </motion.div>
